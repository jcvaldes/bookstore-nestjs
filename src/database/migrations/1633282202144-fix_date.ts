...
export class fixDate1633282202144 implements MigrationInterface {
  name = 'fixDate1633282202144';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "public"."user_details" ALTER COLUMN "created_at" SET DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "public"."user_details" ALTER COLUMN "updated_at" SET DEFAULT now()`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "public"."user_details" ALTER COLUMN "updated_at" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "public"."user_details" ALTER COLUMN "created_at" DROP DEFAULT`,
    );
  }
}
